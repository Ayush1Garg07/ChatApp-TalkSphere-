...
public class ForwardServer extends Thread {
    Socket socket;
    Queue<String> inQueue;  // messages from this client
    Queue<String> outQueue; // messages to this client

    public ForwardServer(Socket s, Queue<String> inQueue, Queue<String> outQueue) {
        this.socket = s;
